      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              Hi, I'm <span style={{ color: "var(--accent-color)" }}>Ceej</span>
              !
            </h1>
            ...
            >
              ...
              using modern technologies like Laravel and React. Let's build
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="w-full mb-8">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {["Laravel", "React", "PostgreSQL", "TailwindCSS"].map(
                  (tech) => (
                    <span
                      key={tech}
